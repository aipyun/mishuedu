...
class ClassroomMarketingSettingSlot extends SlotInjection
{
    public function inject()
    {
        $levels = $this->getVipLevelService()->findEnabledLevels();
        return $this->container->get('twig')->render(
            'VipPlugin:Slot:classroom-vip-setting-slot.html.twig',
            array('levels' => array_column($levels, 'name', 'id'), 'classroom' => $this->classroom)
        );
    }
